						...
						<c:forEach items="${productTypes}" var="productType">
							<tr>
								...
								<td><a
									...
									class="btn btn-warning btn-sm text-white">Xóa</a> <a
									href="${pageContext.request.contextPath}/producttype/updateform?id=${productType.id}"
									class="btn btn-danger btn-sm">Sửa</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
